...
\newcommand{\titulo}{Asistente de accesibilidad en sitios web para personas con discapacidad visual mediante el uso de Inteligencia Artificial}
...
\textcolor{pink}{Considerando lo importancia de este trabajo para los alumnos, este apartado es para que el autor entregue palabras personales para dedicar este documento. La extensión puede ser de máximo una hoja y se deben mantener este formato, tipo y tamaño de letra.}
}
\newcommand{\agradecimientos}{
\textcolor{pink}{Considerando la importancia de este trabajo para los alumnos, este apartado se podrá incluir en el caso de que el autor desee agradecer a las personas que facilitaron alguna ayuda relevante en su trabajo para la realización de este documento. La extensión puede ser de máximo una hoja y se deben mantener este formato, tipo y tamaño de letra.}
}
\newcommand{\resumen}{

Este trabajo presenta el desarrollo del ``Relator de pantalla'', un asistente de accesibilidad web basado en un modelo de lenguaje visual (VLM) que responde en lenguaje natural preguntas sobre el contenido visual de un sitio web —imágenes, gráficos, notificaciones— que los lectores de pantalla no pueden comunicar. La consulta se realiza a partir de una captura de pantalla y una pregunta por texto o por voz, y el sistema fue diseñado para coexistir con el lector de pantalla que el usuario ya utiliza, sin reemplazarlo.

La solución se validó mediante métricas técnicas y entrevistas con personas ciegas en tareas reales sobre sitios web. Los resultados muestran un sistema funcional: una tasa de error de reconocimiento de voz de 4,91\%, una latencia de respuesta promedio de 9,58 segundos, y un desempeño consistentemente pertinente en la evaluación independiente de sus respuestas. Las entrevistas mostraron una impresión general positiva, con buen desempeño en tareas descriptivas y de extracción de información. Estos resultados muestran que un asistente basado en VLM puede complementar a los lectores de pantalla existentes, justamente en el tipo de contenido que estos no pueden comunicar.
}
\newcommand{\resumeningles}{
\textcolor{pink}{Corresponde a la traducción al idioma inglés del Resumen anterior. Sujeto a la misma regla de extensión del Resumen.}
}
\newcommand{\palabrasclave}{

accesibilidad web; discapacidad visual; VLM; lectores de pantalla; \textit{benchmarking}.
}
\newcommand{\palabrasclaveingles}{
\textcolor{pink}{Corresponde a la traducción al idioma inglés de Palabras Clave anteriores.}
}
% @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@>
...
\input{200_introduccion}

\newpage
\input{300_definicion_del_problema}
\newpage
\input{400_marco_conceptual}
\newpage
\input{500_propuesta_de_solucion}
\newpage
\input{600_validacion_de_la_solucion}
\newpage
\input{700_conclusiones}
