...
\newcommand{\resumen}{
\textcolor{pink}{El resumen y las palabras clave no deben superar la mitad de la página, donde debe precisarse brevemente: 1) lo que el autor ha hecho, 2) cómo lo hizo (sólo si es importante detallarlo), 3) los resultados principales, 4) la relevancia de los resultados. El resumen es una representación abreviada, pero comprensiva de la memoria y debe informar sobre el objetivo, la metodología y los resultados del trabajo realizado.}

\begin{itemize}
    \item Relator de pantalla: prototipo de herramienta que interpreta el contenido visual de sitios web y responde por voz a personas con discapacidad visual.
    \item Metodología de trabajo: encuesta -> prototipo -> \textit{benchmark} -> validación con usuarios.
    \item Relevancia: >2.200 millones de personas con deficiencia visual; los lectores de pantalla no interpretan lo visual.
\end{itemize}
}
...
\textcolor{pink}{Cinco es el máximo de palabras clave para describir los temas tratados en la memoria, ponerlas separadas por punto y comas.}
