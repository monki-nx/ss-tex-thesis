...
Es decir, ``generar'' texto y ``predecir la palabra siguiente'' no son dos capacidades distintas, sino una relación de mecanismo a resultado: el modelo predice de forma iterativa, \textit{token} a \textit{token}, y esa cadena de predicciones es percibida por quien lo usa como la generación de una respuesta nueva.
