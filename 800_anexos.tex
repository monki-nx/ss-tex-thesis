...
\begin{table}[h]
    ...
    \begin{tabular}{|p{1.5cm}|p{1.8cm}|p{2.3cm}|p{2cm}|p{5.5cm}|p{1.5cm}|}
        \hline
...
Este anexo detalla el proceso mencionado en el Capítulo 4 (sección de métricas técnicas, exactitud del reconocimiento de voz): las 10 frases leídas en voz alta durante la prueba, la transcripción literal devuelta por el motor de STT de la extensión, y la cantidad de palabras erróneas de cada una respecto del total de palabras de la frase original.

\begin{longtable}{|p{0.6cm}|p{6cm}|p{6cm}|p{1.8cm}|}
    \caption{\label{table:transcripcionesstt} Registro completo de la prueba de reconocimiento de voz: frase original, transcripción obtenida y palabras erróneas por frase.} \\
    \hline
