...
\begin{itemize}
    \item Arquitectura del Relator: sitio -> extensión (captura) -> prototipo (voz + prompt) -> albert (VLM) -> prototipo (TTS) -> audio.
\end{itemize}

\subsection{EXTENSIÓN DE CAPTURA}

\begin{itemize}
    \item La extensión: captura automática en Chrome, viewport visible y página completa (Scroll \& Stitch); output JPG o base64.
\end{itemize}

\subsection{PROTOTIPO / CONTROLADOR}

\begin{itemize}
    \item El prototipo: controlador que orquesta captura + voz + prompt, envía a albert y sintetiza la respuesta en audio.
    \begin{itemize}
        ...
        \item Naturaleza: implementación funcional para validar el pipeline completo, no el producto final.
    \end{itemize}
...
\begin{itemize}
    ...
    \item El sistema de benchmark: procedimiento para seleccionar el VLM más adecuado evaluando sobre sitios reales.
    \begin{itemize}
